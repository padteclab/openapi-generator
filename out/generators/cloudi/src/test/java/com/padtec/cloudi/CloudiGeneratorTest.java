 ...
 * 1) Set a break point in CloudiGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class CloudiGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("cloudi") // use this codegen library
              ...
              .setOutputDir("out/cloudi"); // output directory
