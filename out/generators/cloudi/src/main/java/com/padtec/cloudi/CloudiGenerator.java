...
public class CloudiGenerator extends DefaultCodegen implements CodegenConfig {

    private final Logger LOGGER = LoggerFactory.getLogger(CloudiGenerator.class);
    ...
    public CloudiGenerator() {
        ...
        outputFolder = "generated-code/cloudi";
         ...
         */
        embeddedTemplateDir = templateDir = "cloudi";
    ...
    public void processOpts() {
        ...
        supportingFiles.add(new SupportingFile("cloudi_server.mustache", "", "src" + File.separator + this.packageName + ".erl"));
        ...
        supportingFiles.add(new SupportingFile("cloudi_logic_handler.mustache", "", toSourceFilePath("cloudi_logic_handler", "erl")));
